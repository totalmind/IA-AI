...
从过去的研究目的来看：  
传统的人工智能，研究人脑如何产生智能，然后让机器模仿人脑的思路来实现智能。  
...
而根据中国信通院的人工智能白皮书，存在三个技术流派:    
1. 符号主义又称为逻辑主义。流行于人工智能早期，基于数学推理逻辑，模拟人的抽象逻辑思维。典型的应用有几何定理证明器、专家系统等。  
2. 连接主义又称为仿生学派。以工程技术手段模拟人脑神经系统的结构和功能，即神经网络模型。典型成果有反向传播算法，以及当下的深度学习算法。
3. 行为主义又称为进化主义。基于环境而进行适应性决策，如参考生物学的遗传算法。  
在行为主义思想中引入连接主义的技术，从而诞生了深度强化学习技术，成为 AlphaGo背后的最重要技术。
## 1.2. 价值
**为什么选这个话题？**  
...
8. 
9. 《人工智能发展白皮书-技术架构篇》
10. 《人工智能发展白皮书 产业应用篇.pdf》
- 网站  
 中国信通院：<http://www.caict.ac.cn/kxyj/>
